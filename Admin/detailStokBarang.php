...
//kua=eri tabel barang dan kategori
 				...
 				<br>
 						<table class="table">
 							<thead>
 								<?php
 									include "../koneksi.php";
 									//Kueri tbgabung menggunakan distinct berfungsi agar apabila ada transaksi ditanggal yang sama, maka akan dicatat 1 saja (tidak dobel)
