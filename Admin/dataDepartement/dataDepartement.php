          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-bars"></i> Data Departement</h4>
                <hr>
                <div class="text-center">
                  <a href="?hal=tambahDepartement" class="btn btn-primary"> Tambah Departement </a>
                </div>
                <br>
                <thead>
                   <?php
                  ...
                  <tr>
                    ...
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> Nama Departement</th>
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> Ext Telepon</th>
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i> Nama Manager</th>
