...
$hasil = mysqli_query($sambungin,"SELECT * From tbpenerimaan left join tbdepartement on tbpenerimaan.kode_departement = tbdepartement.kode_departement left join tblogin on tbpenerimaan.id_login = tblogin.id_login");
